...
//        CloudWatchAsyncClient client = Mockito.mock(CloudWatchAsyncClient.class);
//
...
//                                          .namespace("namespace")
//                                          .publishFrequency(Duration.ofMinutes(60))
//                                          .metricCategories(MetricCategory.HTTP_CLIENT, MetricCategory.DEFAULT)
//                                          .dimensions(CoreMetric.SERVICE_ID)
//                                          .detailedMetrics(HttpMetric.MAX_CONCURRENCY)
//                                          .maximumCallsPerPublish(1)
//                                          .build()) {
//
...
//    }
    ...
    private String operation() {
         switch(ThreadLocalRandom.current().nextInt(0, 4)) {
             case 0: return "PutObject";
             case 1: return "GetObject";
             case 2: return "HeadObject";
             case 3: return "ListObjects";
         }
