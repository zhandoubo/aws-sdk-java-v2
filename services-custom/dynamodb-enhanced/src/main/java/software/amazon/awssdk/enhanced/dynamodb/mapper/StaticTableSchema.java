...
public final class StaticTableSchema<T> implements TableSchema<T> {
    private final StaticImmutableTableSchema<T, T> delegateStaticImmutableTableSchema;

    private StaticTableSchema(Builder<T> builder) {
        this.delegateStaticImmutableTableSchema = builder.delegateBuilder.build();
    }
    ...
    public StaticTableMetadata tableMetadata() {
        return this.delegateStaticImmutableTableSchema.tableMetadata();
    }

    @Override
    public T mapToItem(Map<String, AttributeValue> attributeMap) {
        return this.delegateStaticImmutableTableSchema.mapToItem(attributeMap);
    }

    @Override
    public Map<String, AttributeValue> itemToMap(T item, boolean ignoreNulls) {
        return this.delegateStaticImmutableTableSchema.itemToMap(item, ignoreNulls);
    }

    @Override
    public Map<String, AttributeValue> itemToMap(T item, Collection<String> attributes) {
        return this.delegateStaticImmutableTableSchema.itemToMap(item, attributes);
    }

    @Override
    public AttributeValue attributeValue(T item, String key) {
        return this.delegateStaticImmutableTableSchema.attributeValue(item, key);
    }

    @Override
    public EnhancedType<T> itemType() {
        return this.delegateStaticImmutableTableSchema.itemType();
    }

    @Override
    public List<String> attributeNames() {
        return this.delegateStaticImmutableTableSchema.attributeNames();
    }

    @Override
    public boolean isAbstract() {
        return this.delegateStaticImmutableTableSchema.isAbstract();
    }
    ...
    public AttributeConverterProvider attributeConverterProvider() {
        return this.delegateStaticImmutableTableSchema.attributeConverterProvider();
    }

    StaticImmutableTableSchema<T, T> toImmutableTableSchema() {
        return this.delegateStaticImmutableTableSchema;
    }
}
