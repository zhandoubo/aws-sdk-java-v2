...
public interface HttpResponseHandler<T> {
    ...
    String X_AMZN_REQUEST_ID_HEADER_ALTERNATE = "x-amzn-RequestId";
    Set<String> X_AMZN_REQUEST_ID_HEADERS = Stream.of(X_AMZN_REQUEST_ID_HEADER, X_AMZN_REQUEST_ID_HEADER_ALTERNATE)
