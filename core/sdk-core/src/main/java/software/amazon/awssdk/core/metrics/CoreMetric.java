...
public final class CoreMetric {
    ...
    /**
     * True if the API call failed, false otherwise.
     */
    public static final SdkMetric<Boolean> API_CALL_FAILED =
        metric("ApiCallFailed", Boolean.class, MetricLevel.ERROR);
     ...
     *
     * <p>{@code API_CALL_DURATION = CREDENTIALS_FETCH_DURATION + SUM_ALL(BACKOFF_DELAY_DURATION) +
     * SUM_ALL(MARSHALLING_DURATION) + SUM_ALL(SIGNING_DURATION) + SUM_ALL(SERVICE_CALL_DURATION) +
