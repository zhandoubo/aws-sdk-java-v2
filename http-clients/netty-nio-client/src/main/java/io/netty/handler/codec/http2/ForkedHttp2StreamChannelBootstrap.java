...
@UnstableApi
public final class ForkedHttp2StreamChannelBootstrap {
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(ForkedHttp2StreamChannelBootstrap.class);
    ...
    public ForkedHttp2StreamChannelBootstrap(Channel channel) {
    ...
    public <T> ForkedHttp2StreamChannelBootstrap option(ChannelOption<T> option, T value) {
        if (option == null) {
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> ForkedHttp2StreamChannelBootstrap attr(AttributeKey<T> key, T value) {
        if (key == null) {
     ...
     */
    public ForkedHttp2StreamChannelBootstrap handler(ChannelHandler handler) {
